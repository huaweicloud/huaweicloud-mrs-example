...
public class LocalRunner {
	...
	public static void main(String[] args) throws Exception {
		...
		// Security login
		LoginUtil.login(FemaleInfoCollector.PRINCIPAL, FemaleInfoCollector.KEYTAB, FemaleInfoCollector.KRB, conf);
		...
		// If set input parameter,use the input parameters,else use default
		// parameter
	...
	public static Configuration getConfiguration() {
		System.setProperty("java.security.krb5.conf", LocalRunner.class.getClassLoader().getResource("krb5.conf").getPath());
