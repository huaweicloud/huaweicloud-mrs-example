...
# ./bin/spark-submit SparkRExample/src/main/r/ml/glm.R
...
# $example on$
training <- read.df("/example/sample_multiclass_classification_data.txt", source = "libsvm")
...
training2 <- read.df("/example/sample_multiclass_classification_data.txt", source = "libsvm")
...
training3 <- read.df("hdfs://hacluster/example/sample_multiclass_classification_data.txt", source = "libsvm")
