 ...
 * method with a HBase connection putting data  to hbase table.
 */
public final class JavaHBaseForEachPartitionExample {
    public static void main(String[] args) throws Exception {
        ...
        final SparkConf sparkConf = new SparkConf().setAppName("JavaHBaseBulkGetExample " + tableName);
        ...
        try {
            ...
            // using hbaseContext foreachPartition function writes data to HBase table.
