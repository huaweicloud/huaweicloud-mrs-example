...
JAR_STR="${BIGDATA_CLIENT_HOME}/HBase/hbase/lib/ctbase-core-0.95.0-h0.cbu.mrs.320.r11.jar,\
${BIGDATA_CLIENT_HOME}/HBase/hbase/lib/hbase-it-bulk-load-8.2.0-320.r11.jar,\
...
--jars "${JAR_STR}" \
${CONF_STR} \
ctbase-export-examples-8.2.0-320.r11.jar \
