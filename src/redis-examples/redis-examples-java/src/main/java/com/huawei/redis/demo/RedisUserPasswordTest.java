 ...
 * @since 2020-09-30
 */
public class RedisUserPasswordTest {
    /**
     * logger
     */
    private static final Logger LOGGER = Logger.getLogger(RedisUserPasswordTest.class);
     ...
     * 构造函数
     */
    public RedisUserPasswordTest() throws Exception {
        ...
        int maxAttempts = 2;
        boolean ssl = true;
        client = new JedisCluster(hosts, timeout, timeout, maxAttempts, Const.userName, Const.password, null,
    ...
    public static void main(String[] args) throws Exception {
        RedisUserPasswordTest test = new RedisUserPasswordTest();
