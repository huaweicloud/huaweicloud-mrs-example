...
public class WriteIntoHudiWithSyncHive {
  public static void main(String[] args) throws Exception {
    ...
    System.out.println(
        "flink run-application -t yarn-application -Dyarn.ship-files=\"ssl/\" --class com.huawei.bigdata.flink.examples.WriteIntoHudiWithSyncHive"
            + " /opt/test.jar --hudiTableName hudiSinkTable --hudiPath hdfs://hacluster/tmp/flinkHudi/hudiTable"
            + " --uris xxx --kerberosPrincipal xxx"
    );
    System.out.println(
        "******************************************************************************************");
    ...
    System.out.println("<uris> The value of hive.metastore.kerberos.principal in hive-site.xml");
    System.out.println(
        "******************************************************************************************");
    ...
    String kerberosPrincipal = paraTool.get("kerberosPrincipal");
    ...
    options.put(FlinkOptions.HIVE_SYNC_METASTORE_KERBEROS_PRINCIPAL.key(), kerberosPrincipal);
