...
public class MultiComponentExample {
	...
	public static void main(String[] args) throws Exception {
		...
		Class hiveSqlExceptionClass = Class.forName("org.apache.hive.service.cli.HiveSQLException");
		//Class hiveShimClass = Class.forName("org.apache.hadoop.hive.thrift.HadoopThriftAuthBridge23");

		// add dependency jars to Job
		JarFinderUtil.addDependencyJars(config, hiveDriverClass, thriftClass, hiveConfClass,
				hiveTransClass, hiveMetaClass, hiveSqlExceptionClass);
