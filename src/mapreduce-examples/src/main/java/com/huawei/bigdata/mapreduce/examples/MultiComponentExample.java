...
public class MultiComponentExample {
	...
	public static void main(String[] args) throws Exception {
		...
		Class hiveSqlClass = Class.forName("org.apache.hive.service.cli.HiveSQLException");
		Class thriftClass = Class.forName("org.apache.thrift.TException");
		Class thriftCLIClass = Class.forName("org.apache.hive.service.rpc.thrift.TCLIService");
		...
		JarFinderUtil.addDependencyJars(config, hiveDriverClass, thriftCLIClass, thriftClass, hiveConfClass,
				hiveTransClass, hiveMetaClass, hiveShimClass, hiveSqlClass);
