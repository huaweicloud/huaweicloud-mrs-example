...
public class HBaseExample {
    ...
    public HBaseExample(Configuration conf, String tableName) throws IOException {
        this.conf = conf;
    ...
    public void testCreateTable() {
        ...
        ColumnFamilyDescriptor familyDescriptor = ColumnFamilyDescriptorBuilder.newBuilder(fam)
                ...
                .build();
        TableDescriptor htd = TableDescriptorBuilder.newBuilder(tableName).setColumnFamily(familyDescriptor).build();
    ...
    public void testSingleColumnValueFilter() {
        ...
        try {
            ...
            SingleColumnValueFilter filter = new SingleColumnValueFilter(Bytes.toBytes("info"),
                    Bytes.toBytes("name"), CompareOperator.EQUAL, Bytes.toBytes("Xu Bing"));
    ...
    public void grantACL() {
        ...
        try {
            ...
            TableDescriptor ht = TableDescriptorBuilder.newBuilder(tableName).build();
