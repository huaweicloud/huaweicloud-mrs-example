...
public class SimpleHDFSTopology {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 写入hdfs的目的文件
        // HdfsBolt必选参数
        FileNameFormat fileNameFormat = new DefaultFileNameFormat().withPath(HDFS_TEMP_PATH);
    ...
    private static void setSecurityConf(Config conf, AuthenticationType type) {
        ...
        switch (type) {
            ...
            case TICKET_CACHE: {
                autoTgts.add(SECURITY_AUTO_TGT_PLUGIN);
                autoTgts.add(SECURITY_AUTO_HDFS_PLUGIN);
            }
        }
