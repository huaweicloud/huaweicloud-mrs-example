...
public class WordCountTopology {
    ...
    private static void remoteSubmit(TopologyBuilder builder)
            throws AlreadyAliveException, InvalidTopologyException, AuthorizationException, IOException {
     ...
     * 本地模式提交，一般用来测试
     */
    private static void localSubmit(TopologyBuilder builder) throws InterruptedException {
    ...
    private static void securityPrepare(Config config) throws IOException {
