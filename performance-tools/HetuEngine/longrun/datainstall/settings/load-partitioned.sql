--changed by lilele 00285972,deleted the comment tag
set hive.enforce.bucketing=true;
set hive.enforce.sorting=true;
--added by lilele 00285972
...
--create database if not exists tpcds_bin_partitioned_orc_2  LOCATION 'obs://b060security/user/hive/warehouse/tpcds_bin_partitioned_orc_2';
